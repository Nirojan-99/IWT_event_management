...
<!-- body section-->
		...
		<div class="editP" id="editP">
			<button class="editB" ><a href="changepass.php">Change Password</a></button><br>
			<button class="editB" ><a href="changeaddr.php">Change Address</a></button><br>
			<button class="editB" ><a href="changemob.php">Change Mobile Number</a></button><br>
		</div>

...
<input type=hidden value='<?php echo $job; ?>' name=jid>
			...
			<input list="location" name="location" placeholder='<?php echo $Rlocation; ?>' ><br>
			...
			<input list="gender" name="gen" id="gen" placeholder='<?php echo $Rgen; ?>'  >
			  <datalist id="gender" >
			    <option value="Male">
			    <option value="Female">
			    <option value="Both">
			...
			<input list="type" placeholder='<?php echo $Rjtype; ?>' name="jobtype" >
			<datalist id="type" >
